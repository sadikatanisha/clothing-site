    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="py-16 px-4 sm:px-10">
        <div className="max-w-4xl mx-auto flex flex-col lg:flex-row items-center gap-8">
          <div className="lg:w-1/2">
            <img
              src="https://images.pexels.com/photos/428340/pexels-photo-428340.jpeg?auto=compress&cs=tinysrgb&w=800"
              alt="Artisan at work"
              className="w-full h-auto rounded-lg shadow-lg object-cover"
            />
          </div>
          <div className="lg:w-1/2">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#800f44] mb-4">
              Our Story
            </h2>
      ...
      <section className="bg-gray-50 py-16 px-4 sm:px-10">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#800f44] text-center mb-8">
            Mission & Values
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              <h3 className="text-xl font-semibold text-[#800f44] mb-2">
                Craftsmanship
              </h3>
      ...
      <section className="py-16 px-4 sm:px-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#800f44] mb-8">
            Meet the Team
          </h2>
      ...
      {/* Call to Action */}
      <section className="bg-[#800f44] text-white py-12">
