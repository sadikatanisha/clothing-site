...
const CartSlider = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex justify-between items-center px-4 py-8 border-b border-gray-100 pt-16">
      ...
      <div className="px-4 py-4 border-t border-gray-200">
        ...
        <Link
          to="/checkout"
          onClick={onClose}
          className="block w-full text-center bg-[#800f44] text-white py-2 rounded"
        >
          Checkout
        </Link>
      </div>
