  ...
  return (
    <>
      ...
      <nav className="sticky top-0 w-full bg-white text-black border-b-2 border-gray-200 z-30 pt-10 lg:pt-14 px-6 lg:px-10 py-4 lg:py-6">
        ...
        {/* Mobile Navbar (logo + login/profile + cart + hamburger) */}
        ...
        <div
          className={`
            fixed
            top-10            /* 2.5rem = 40px under PromoBar */
            left-0
            w-full
            h-screen         /* fill screen below that 40px */
            bg-white
            z-40             /* under PromoBar (z-50) */
